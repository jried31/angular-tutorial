...
*/
import { Component, OnInit, OnDestroy, Input, Output, ViewEncapsulation,
...
@Component({
  ...
  /*
  Component CSS styles are encapsulated into the component's view and don't affect the rest of the application. To control how this encapsulation happens on a per component basis, you can set the view encapsulation mode in the component metadata. Native view encapsulation uses the browser's native shadow DOM implementation (see Shadow DOM on the MDN site) to attach a shadow DOM to the component's host element, and then puts the component view inside that shadow DOM. The component's styles are included within the shadow DOM.

  In other words, looking at the Inspector one will see that style tags are generated for the CSS within this widget and they are viewable ONLY to this component and it's children noth outside others.
  */
